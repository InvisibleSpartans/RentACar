...
export class CarDetailsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.listval=[
      {"img_val":"a1.JPG","Description":"Mahindra KUV 100 ","Seater":5,"Rate":20},
      {"img_val":"a2.JPG","Description":"Ford Figo ","Seater":5,"Rate":20},
      {"img_val":"a3.JPG","Description":"Scorpio","Seater":7,"Rate":30},
   ];
  }
